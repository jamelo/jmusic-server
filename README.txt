...
- built in Flash MP3 player with (poor) equalizer and playback queue
...
3) Register using register.php



Known Issues and Annoyances:

- there's currently no way to rename playlists, or even specify a name for them
...
- the equalizer is terrible and inefficient